...
class WhoopsResource(relations_restx.Resource):
    MODEL = Whoops
...
class TestResourceError(unittest.TestCase):
    ...
    def test___init__(self):
        ...
        error = relations_restx.ResourceError("unittest", "oops")
    ...
    def test___str__(self):
        ...
        error = relations_restx.ResourceError(WhoopsResource(), "adaisy")

        self.assertEqual(str(error), "WhoopsResource: adaisy")


class TestResourceIdentity(TestRestX):
    ...
    def test_thy(self):
        ...
        class InitResource(relations_restx.ResourceIdentity):
            MODEL = Init
...
class TestResource(TestRestX):
    ...
    def test___init__(self):
        ...
        class InitResource(relations_restx.Resource):
            MODEL = Init
    ...
    def test_json(self):
        ...
        @relations_restx.exceptions
        def json():
            return {"json": relations_restx.Resource.json()}
    ...
    def test_criteria(self):
        ...
        @relations_restx.exceptions
        def criteria(method=None):
            return {"criteria": relations_restx.Resource.criteria(verify)}
    ...
    def test_sort(self):
        ...
        @relations_restx.exceptions
        def sort():
            return {"sort": relations_restx.Resource.sort()}
    ...
    def test_limit(self):
        ...
        @relations_restx.exceptions
        def limit():
            return {"limit": relations_restx.Resource.limit()}
    ...
    def test_count(self):
        ...
        @relations_restx.exceptions
        def count():
            return {"count": relations_restx.Resource.count()}
    ...
    def test_formats(self):
        ...
        class AdvancedResource(relations_restx.Resource):
