...
class TestUnitTest(relations_restx.unittest.TestCase):
    ...
    def test_assertConsistent(self):
        ...
        with unittest.mock.patch('relations_restx.unittest.TestCase.assertEqual') as mock_equal:
    ...
    def test_assertContains(self):
        ...
        with unittest.mock.patch('relations_restx.unittest.TestCase.assertIn') as mock_in:
