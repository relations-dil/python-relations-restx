...
class TestSource(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.source = relations_restx.Source("TestRestXSource", "", self.app.test_client())
    ...
    def test___init__(self, mock_session):
        ...
        source = relations_restx.Source("unit", "http://test.com", a=1)
        ...
        source = relations_restx.Source("test", "http://unit.com", session="sesh")
